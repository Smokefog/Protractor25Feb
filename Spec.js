...
describe('This is a sample application to test consumption', function () {
    ...
    it('This is to test the calendar of the object in protractor', function () {
        protractor_1.browser.get(protractor_1.browser.params.testUrl);
        ...
        protractor_1.browser.takeScreenshot().then(function (png) {
            ...
            var startDate;
            startDate = protractor_1.element(protractor_1.by.xpath('/html/body/div[1]/md-content/div[1]/docs-demo[1]/div/div/section/demo-include/div/md-content/div[2]/div[1]/md-datepicker/div/input'));
            startDate.clear();
            protractor_1.browser.sleep(5000);
            protractor_1.browser.executeScript('arguments[0].value="2/28/2019";', startDate);
            protractor_1.element(protractor_1.by.xpath('/html/body/div[1]/md-content/div[1]/docs-demo[1]/div/div/section/demo-include/div/md-content/div[2]/div[1]/md-datepicker/div/input')).sendKeys(protractor_1.protractor.Key.TAB);
            protractor_1.browser.sleep(5000);
            var stream = fs_1.createWriteStream('pic1.png');
